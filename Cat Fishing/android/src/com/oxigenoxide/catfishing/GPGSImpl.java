...
*/
    private final String LEADERBOARD = "CgkIuILUzdoDEAIQCQ";
    ...
    public void init( AndroidLauncher context ) {
        ...
        System.out.println("lboards: " + R.string.leaderboard_highscores);
    ...
    public void submitScore( long score ) {
        ...
        //System.out.println("submitScore( " + score + " )");
        PendingResult r = Games.Leaderboards.submitScoreImmediate(client, LEADERBOARD, score);
        ResultCallback callback = new ResultCallback()
        {
            @Override
            public void onResult(@NonNull Result result)
            {
                //System.out.println("subMitted: " + result.getStatus());
    ...
    public void onConnected( Bundle connectionHint ) {
        Log.d( className, "Client: Success connected xD ._." );
    }
